...
def seed_tags():
    ...
    tags = [haunted_mansion, horror, paranormal, ghost,spooky_season, fright_fest, dead_bride, haunted_house, abandoned, american_horror_story, soldier, bride, dead, afterlife, cemetary, murder, ghoul]
...
def undo_tags():
    ...
    db.session.execute('TRUNCATE house_tags;')
    db.session.commit()
